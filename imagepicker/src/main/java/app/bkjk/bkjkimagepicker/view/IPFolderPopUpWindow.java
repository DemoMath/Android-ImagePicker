 ...
 * 版    本：
 * 创建日期：2018/6/4
 * 描    述：IPFolderPopUpWindow.java
 * 修订历史：
 * ================================================
 */
public class IPFolderPopUpWindow extends PopupWindow implements View.OnClickListener {
    ...
    public IPFolderPopUpWindow(Context context, BaseAdapter adapter) {
        super(context);

        final View view = View.inflate(context, R.layout.bkjk_imagepicker_pop_folder, null);
    ...
    private void exitAnimator() {
        ...
        set.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                IPFolderPopUpWindow.super.dismiss();
            }
