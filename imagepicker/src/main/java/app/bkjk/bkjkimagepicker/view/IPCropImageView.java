 ...
 * ================================================
 */
public class IPCropImageView extends AppCompatImageView {
    ...
    public IPCropImageView(Context context) {
        this(context, null);
    }

    public IPCropImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IPCropImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BKJKImagePickerCropImageView);
        mMaskColor = a.getColor(R.styleable.BKJKImagePickerCropImageView_cropMaskColor, mMaskColor);
        mBorderColor = a.getColor(R.styleable.BKJKImagePickerCropImageView_cropBorderColor, mBorderColor);
        mBorderWidth = a.getDimensionPixelSize(R.styleable.BKJKImagePickerCropImageView_cropBorderWidth, mBorderWidth);
        mFocusWidth = a.getDimensionPixelSize(R.styleable.BKJKImagePickerCropImageView_cropFocusWidth, mFocusWidth);
        mFocusHeight = a.getDimensionPixelSize(R.styleable.BKJKImagePickerCropImageView_cropFocusHeight, mFocusHeight);
        mDefaultStyleIndex = a.getInteger(R.styleable.BKJKImagePickerCropImageView_cropStyle, mDefaultStyleIndex);
    ...
    private Bitmap makeCropBitmap(Bitmap bitmap, RectF focusRect, RectF imageMatrixRect, int expectWidth, int exceptHeight, boolean isSaveRectangle) {
        ...
        try {
            ...
            if (expectWidth != width || exceptHeight != height) {
                ...
                if (mStyle == IPCropImageView.Style.CIRCLE && !isSaveRectangle) {
                    //如果是圆形，就将图片裁剪成圆的
